...
const INTEREST_GROUPS = [
  {
    ...
    items: [
      { value: 'Host a Peer-to-Peer Fundraiser', label: 'Host a Peer-to-Peer Fundraiser', description: 'Rally your friends, team, or classmates around a birthday, race, or milestone. We build the page and send you a link and QR code — you just share it.' },
      { value: 'Special Events & Advocacy', label: 'Special Events & Advocacy', description: 'Donate your expertise year-round on an event committee, or speak up for our kids with local officials, schools, and civic groups.' },
      { value: 'Collections & Drives', label: 'Collections & Drives', description: 'Get your office, school, or congregation together to collect what our kids need most. We’ll tell you what’s running low.' },
  ...
  },
  {
    ...
    note: 'Brighten our kids’ days with something you put together at home and drop off, or a project you pitch in on. Even a simple drop-off makes a real difference — and just being on-site can be inspiring. Someone from our Kids In Crisis Leadership Team will meet with you to find the best fit and arrange drop-offs.',
    items: [
      ...
      { value: 'Restock Our Clinic', label: 'Restock Our Clinic', description: 'Every kid at the shelter uses our clinic. Help us keep toiletries and drugstore essentials stocked.' },
      { value: 'Birthday Baskets', label: 'Birthday Baskets', description: 'Help make birthdays special for the kids staying in the shelter by providing cakes, baking supplies or party favors.' },
      { value: 'Facility Upkeep', label: 'Facility Upkeep', description: 'Organize, paint, or garden while the kids are at school.' },
      { value: 'Youth Corps', label: 'Youth Corps', description: 'High school students can be part of our Youth Corps — meet monthly to work on projects that support our residents.' },
    ],
  },
  {
    heading: 'Tier 3 — Participate in One of Our External Programs',
    note: 'Take part in one of our programs out in the community. Because you will be working with non-resident children, these roles require additional background checks and paperwork.',
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      { value: 'Share Your Talents with our Kids', label: 'Share Your Talents with our Kids', description: 'Bring what you love to the kids after school — art, music, dance, yoga, sports, cooking, personal finance — weekly visits are gold.' },
